...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/huichenjima\">hechen</a>");
        ...
        packageConfig.setParent("com.hechen.mallchat.common.chat");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("20011010hc");
        dataSourceConfig.setUrl("jdbc:mysql://192.168.101.128:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}