...
import com.hechen.mallchat.common.common.service.cache.AbstractRedisStringCache;
...
public class UserSummaryCache extends AbstractRedisStringCache<Long, SummeryInfoDTO> {
    ...
    @Override
    protected Map<Long, SummeryInfoDTO> load(List<Long> uidList) {//后续可优化徽章信息也异步加载，用户有什么徽章没有redis缓存，只有springcache缓存
        //用户基本信息
