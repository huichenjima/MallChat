...
import com.hechen.mallchat.common.common.annotation.FrequencyControl;
import com.hechen.mallchat.common.common.domain.dto.FrequencyControlDTO;
import com.hechen.mallchat.common.common.service.frequencycontrol.FrequencyControlUtil;
...
import static com.hechen.mallchat.common.common.service.frequencycontrol.FrequencyControlStrategyFactory.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.hechen.mallchat.common.common.annotation.FrequencyControl)||@annotation(com.hechen.mallchat.common.common.annotation.FrequencyControlContainer)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (int i = 0; i < annotationsByType.length; i++) {
            ...
            String prefix = StrUtil.isBlank(frequencyControl.prefixKey()) ? SpringElUtils.getMethodKey(method) + ":index:" + i : frequencyControl.prefixKey();//默认方法限定名+注解排名（可能多个）
            String key = "";
            switch (frequencyControl.target()) {
                case EL:
                    key = SpringElUtils.parseSpringEl(method, joinPoint.getArgs(), frequencyControl.spEl());
                    break;
                case IP:
