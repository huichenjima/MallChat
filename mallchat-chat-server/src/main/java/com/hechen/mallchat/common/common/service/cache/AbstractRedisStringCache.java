package com.hechen.mallchat.common.common.service.cache;
...
/**
 * Description: redis string类型的批量缓存框架，redis批量缓存框架
 * Author: <a href="https://github.com/zongzibinbin">abin</a>
 * Date: 2023-06-10
 */
public abstract class AbstractRedisStringCache<IN, OUT> implements com.hechen.mallchat.common.common.service.cache.BatchCache<IN, OUT> {
