...
import static com.hechen.mallchat.common.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.hechen.mallchat.common.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
import static com.hechen.mallchat.common.user.domain.enums.ApplyTypeEnum.ADD_FRIEND;
